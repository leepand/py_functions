...
Write().write_api(str("算法接口自动生成"), group_data=[{"name":"项目-推荐引擎",
                                           "First":[{"name":"优惠券推荐",
                                                     ...
                                                     "requestParameter":[{"name":"x","_type":"string","required":"yes","restrict":"yes"},
                                                                         {"name":"y","_type":"string","required":"","restrict":"yes"}],
                                                     "response":[],
                                                     "data":'{"x":1,"y":20}'
                                                    },{"name":"选址预测",
                                                     "description":"基于用户行为的优惠券推荐接口",
                                           ...
                                           "First":[{"name":"优惠券推荐",
                                                     ...
                                                     "requestParameter":[{"name":"x","_type":"string","required":"yes","restrict":"yes"},
                                                                         {"name":"y","_type":"string","required":"","restrict":"yes"}],
                                                     "response":[{"name":"x","_type":"string","required":"yes","description":"点击"},
                                                                  {"name":"y","_type":"string","required":"","description":"浏览"}],
                                                     "data":'{"x":1,"y":20}'
                                                    }]
                                          }], data="obn")
