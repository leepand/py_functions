...
def participate(
    experiment_name, alts, client_id=None, force=None, record_force=False, params={}
):
...
class Session(object):
    def __init__(self, client_id=None, options={}, params={}):
        default_options = {"host": AB_HOST, "timeout": AB_TIMEOUT}
    ...
    def participate(
        self, experiment_name, alternatives, force=None, record_force=False
    ):
