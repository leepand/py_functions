...
r_server_a = redis.StrictRedis(host= "xx.com",
                             port= 6379,
                             db= 10)
...
def predict_churn22(uid,
    ...
    msg = {"result": {"status": status,"predicted_churn":str(predicted_churn)}, 
...
router = ModelkitAutoAPIRouter(
    required_models=["onlinepredictchurn"],
    models=[onlinePredictChurn])
app.include_router(router)

data = {"async_user_id":"6674637",
